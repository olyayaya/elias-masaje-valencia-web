...
export const en: Translations = {
  ...
  testimonials: {
    ...
    items: [
      { quote: "I left feeling like new. Elias has incredible hands and a very professional manner.", name: "Carlos M." },
      { quote: "The best massage I've had in Valencia. The space transmits total calm.", name: "Laura P." },
      { quote: "After months of back pain, I noticed a huge improvement in just three sessions.", name: "David R." },
    ],
  },
