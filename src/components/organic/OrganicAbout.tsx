...
const OrganicAbout = () => {
  ...
  return (
    <div>
      ...
      <div
        className="relative h-16 md:h-24 -mb-4 pointer-events-none z-10"
        style={{ backgroundColor: isDG ? "hsl(var(--organic-dark))" : bgColor("--organic-dark") }}
        aria-hidden="true"
      >
        <svg viewBox="0 0 1440 96" preserveAspectRatio="none" className="absolute inset-x-0 top-0 w-full" style={{ height: "calc(100% + 1rem)" }}>
