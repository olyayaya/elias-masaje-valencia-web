...
const FontPreview = () => {
  ...
  // Set global CSS variables on document root so fonts change everywhere
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="font-display text-3xl mb-2">Typography Preview</h1>
        ...
        <div className="bg-card rounded-2xl p-10 md:p-14 mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl leading-[1.15] mb-5">
            {SAMPLE.headline}
          </h2>
