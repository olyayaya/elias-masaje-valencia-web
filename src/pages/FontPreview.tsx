  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        {/* Preview — use a wrapper div with CSS vars to override base styles */}
        <div
          key={pair.id}
          style={{
            ["--preview-display" as string]: pair.display,
            ["--preview-body" as string]: pair.body,
          }}
        >
          {/* Font info */}
          <div className="flex gap-8 text-sm text-muted-foreground mb-12" style={{ fontFamily: pair.body }}>
            <div>
